    ...
    <div className='container mx-auto text-center'>
      ...
      <div className='sm:flex justify-center mt-[48px] mx-10'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-20 mx-auto">
          ...
          <p className='mt-[8px] text-sm'>
          We’re committed to providing you with exceptional service every step of the way. Our dedicated Customer Support team is here to ensure that your shopping experience is smooth, enjoyable, and hassle-free.
          </p>
        </div>
